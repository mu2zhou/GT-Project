...
if __name__ == "__main__":
    ...
    dataset_labels = ["OpenACC Casale", "OpenACC Vicolungo"]
    ...
    # ===== 新增 BEV 轨迹可视化 =====
    draw_BEV_trajectory('./Dataset/OpenACC/output/step3_Casale.csv', 'Casale', './Analysis/BEV')
    draw_BEV_trajectory('./Dataset/OpenACC/output/step3_Vicolungo.csv', 'Vicolungo', './Analysis/BEV')

    # ===== 新增 BEV-XY 轨迹俯视图 =====
    draw_BEV_xy_trajectory('./Dataset/OpenACC/output/step3_Casale.csv',
                           'Casale', './Analysis/BEV_xy')
    draw_BEV_xy_trajectory('./Dataset/OpenACC/output/step3_Vicolungo.csv',
                           'Vicolungo', './Analysis/BEV_xy')
